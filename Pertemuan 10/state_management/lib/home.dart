...
//fungsi removeTomato() bisa dilihat di filecontroller.dart
                        c.removeTomato(),
                      },
                      child: Container(
                        width: 45,
...
//fungsi addCabbage() bisa dilihat di filecontroller.dart
                      onTap: () => c.addCabbage(),
                      child: Container(
                        width: 45,
                        height: 45,
...
//variabel cabbage akan secara reaktif bertambah atauber kurang saat tombol + atau - ditap
//perlu dibungkus dengan Obx() agar variabel di dalamnya dapat berubah secara reaktif
                    Obx(
                      () => Text(
                        "${c.cabbage.toString()}",
...
//fungsi removeCabbage() bisa dilihat di filecontroller.dart
